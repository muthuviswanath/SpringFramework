		...
		try {
			...
			while(rs.next()) {
				...
				System.out.println("Employee Name: " + rs.getString("EMP_NAME"));
					...
					System.out.println("Employee Department ID: " + rs.getInt("DEPT_ID"));
					System.out.println("Employee Manager ID: " + rs.getInt("MANAGER_ID"));
					System.out.println("-----------------------------");
			}
		}
		catch (Exception e) {
